...
export default function Balance() {
    return (
        <div className=" bg-custom-white dark:bg-custom-darkbackground shadow-lg w-full flex flex-col justify-between h-[220px] py-8 px-6 rounded-lg border border-transparent dark:border-gray-700">
