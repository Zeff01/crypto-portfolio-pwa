	...
	return (
		<div className='flex flex-row justify-between '>
			<Select
				...
				onOpenChange={setSorterStatus}
			>
				<SelectTrigger className='w-[180px] border-none border-0 py-3 font-[500] dark:bg-custom-card/60'>
			...
			<div className='flex flex-row gap-x-2'>
				{listType === 'card' ? (
					...
					>
						...
						>
							<rect
								className='fill-custom-black dark:fill-custom-teal'
								width='16'
								height='7'
								rx='2'
								fill='#1E1E1E'
				...
				<Button
					className='gap-x-1 rounded-full px-4 bg-custom-card hover:bg-custom-card dark:text-custom-white dark:bg-custom-card/60'
