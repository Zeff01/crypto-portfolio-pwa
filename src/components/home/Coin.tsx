...
export default function Coin({ quote, iconUrl, symbol }: CoinProps) {
	...
	return (
		<div className='bg-custom-white dark:bg-custom-card/50  min-w-[200px] rounded-md shadow-md px-5 py-4 border border-transparent dark:border-gray-700'>
			...
			<div>
				<p
					className={`${
						percent_change_24h > 0 ? 'text-custom-teal' : 'text-custom-destructive'
